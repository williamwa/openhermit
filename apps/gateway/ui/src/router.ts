...
export type Tab = 'fleet' | 'skills' | 'mcp-servers' | 'schedules' | 'containers' | 'stats' | 'logs';

const VALID_TABS: readonly Tab[] = ['fleet', 'skills', 'mcp-servers', 'schedules', 'containers', 'stats', 'logs'];
